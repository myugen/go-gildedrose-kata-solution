...
func TestAgedEvaluator_Evaluate(t *testing.T) {
	...
	testcases := []struct {
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Aged-evaluated item", SellIn: -1, Quality: quality.RegularMaximumQuality}},
