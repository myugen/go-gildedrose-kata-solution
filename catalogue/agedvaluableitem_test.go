...
func TestAgedValuableItem_Update(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			args: args{item: gildedrose.Item{Name: "Aged-valuable item", SellIn: 1, Quality: 9}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Aged-valuable item", SellIn: 0, Quality: 10}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Aged-valuable item", SellIn: -1, Quality: 12}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Aged-valuable item", SellIn: -1, Quality: quality.RegularMaximumQuality}},
