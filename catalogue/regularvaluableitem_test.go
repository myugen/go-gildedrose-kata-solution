...
func TestRegularValuableItem_Update(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			args: args{item: gildedrose.Item{Name: "Regular-evaluable item", SellIn: 1, Quality: 9}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Regular-evaluable item", SellIn: 0, Quality: 8}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Regular-evaluable item", SellIn: -1, Quality: 6}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Regular-evaluable item", SellIn: -1, Quality: quality.RegularMinimumQuality}},
