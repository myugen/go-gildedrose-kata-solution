...
func TestEventualValuableItem_Update(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			args: args{item: gildedrose.Item{Name: "Eventual-valuable item", SellIn: 11, Quality: 10}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Eventual-valuable item", SellIn: 10, Quality: 11}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Eventual-valuable item", SellIn: 5, Quality: 13}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Eventual-valuable item", SellIn: 0, Quality: 16}},
		...
		},
		{
			...
			args: args{item: gildedrose.Item{Name: "Eventual-valuable item", SellIn: 4, Quality: quality.RegularMaximumQuality}},
